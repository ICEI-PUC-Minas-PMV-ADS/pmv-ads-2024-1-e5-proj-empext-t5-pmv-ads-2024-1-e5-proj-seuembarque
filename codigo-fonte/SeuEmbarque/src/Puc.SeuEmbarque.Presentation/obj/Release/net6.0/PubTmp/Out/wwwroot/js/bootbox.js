...
(function (root, factory) {
  ...
  var templates = {
    ...
    '</div>',
    footer:
    '<div class="modal-footer"style="border-top:white;"></div>',
    closeButton:
    '<button type="button" style="color:white; font-weight: 100;" class="bootbox-close-button close" aria-hidden="true">&times;</button>',
    form:
